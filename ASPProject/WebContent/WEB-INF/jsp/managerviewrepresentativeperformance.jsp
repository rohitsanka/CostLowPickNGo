...
<tr ><th>Representative Name</th><th>No of Completed Orders</th></tr>
   <c:forEach var="representativePerformance" items="${representativePerformance}">   

   <td>${representativePerformance.representativename}</td>  
   <td>${representativePerformance.noOfOrdersForRepresentative}</td>  
