...
<tr ><th>Order ID</th><th>Customer Name</th><th>Order Status</th></tr>
   <c:forEach var="orderListItems" items="${orderList}">   
<tr>
   <td>${orderListItems.orderId}</td>  
   <td>${orderListItems.customerName}</td>  
      <td>${orderListItems.productName}</td>  
      <td>${orderListItems.productQuantity}</td>  </tr>
