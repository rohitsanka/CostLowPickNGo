...
<div class="rightcol">
	...
	<h1> Add Employee</h1>
<spring:form action="${pageContext.request.contextPath}/adminController/addEmployeeDb"  modelAttribute="addEmployee" id="addEmployee">  
User Name:<spring:input path="userName"/><br/>  
Password:<spring:password path="password"/><br/> 
Role: <spring:select path="role" items="${allRoles}" itemValue="id" itemLabel="name"/><br/>
...
<input type="submit" class="login login-submit" value="Add Employee"/>  
</spring:form> 
