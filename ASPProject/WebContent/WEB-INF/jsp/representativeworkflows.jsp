...
<tr ><th>Order ID</th><th>Manager Name</th></tr>
   <c:forEach var="workFlow" items="${workFlowItems}">   
<tr>
   <td>${workFlow.orderId}</td>  
   <td>${workFlow.managerName}</td>  
   <td><a href="${pageContext.request.contextPath}/representativeController/viewOrder/${workFlow.orderId}">View Order</a></td>
   <td><a href="${pageContext.request.contextPath}/representativeController/completeWorkFlow/${workFlow.orderId}">Complete Work flow</a></td></tr>
