...
<tr ><th>Order ID</th><th>Customer Name</th><th>Order Status</th></tr>
   <c:forEach var="openOrderListItems" items="${openOrderList}">   
<tr>
   <td>${openOrderListItems.orderId}</td>  
   <td>${openOrderListItems.customerName}</td>  
   <td><a href="${pageContext.request.contextPath}/managerController/viewOrder/${openOrderListItems.orderId}">View Order</a></td>
      <td><a href="${pageContext.request.contextPath}/managerController/assignWorkFlow/${openOrderListItems.orderId}">Assign Work flow</a></td></tr>
   
<%--    <td><a href="/managerController/dropcourse/${openOrderListItems.orderId}">View Order</a></td></tr>
 --%>   </c:forEach>  
