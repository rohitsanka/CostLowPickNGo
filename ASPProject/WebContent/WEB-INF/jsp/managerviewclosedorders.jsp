...
<tr ><th>Order ID</th><th>Representative Name</th></tr>
   <c:forEach var="processingOrderList" items="${processingOrderList}">   
   <tr><td>${processingOrderList.orderId}</td>  
   <td>${processingOrderList.representativename}</td>  
   </tr>
   </c:forEach>  
