...
<link href="<c:url value="/resources/css/loginstylesheet2.css" />" rel="stylesheet" type="text/css"/>
...
<div class="rightcol">
	...
	<table>
<tr><th>${order.orderId} </th></tr>
<tr><th>Grocery</th></tr>
  <c:forEach var="product" items="${order.groceryList}" varStatus="loop" >
  <tr><td>${product.productName }</td>
    <td>${product.productQuantity }</td></tr>
  
  
  
  </c:forEach>
  <tr><th>Soda</th></tr>
  <c:forEach var="product" items="${order.sodaList}" varStatus="loop" >
  <tr><td>${product.productName }</td>
    <td>${product.productQuantity }</td></tr>
  ...
  <tr><th>Smokes</th></tr>
  <c:forEach var="product" items="${order.smokesList}" varStatus="loop" >
  <tr><td>${product.productName }</td>
    <td>${product.productQuantity }</td></tr>
