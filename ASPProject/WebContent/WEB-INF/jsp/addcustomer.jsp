...
<link href="<c:url value="/resources/css/addcustomerstyle.css" />" rel="stylesheet" type="text/css"/>
	...
	<div class="header">
		...
		<div class="menu">
        	<ul>
                ...
                <li><a href="${pageContext.request.contextPath}/adminController/logout">Logout</a></li>
        	</ul>
        </div>
	</div>
</div><!---header-wrap--->
		...
		<div class="block">
        	<div class="panel">
                ...
                <div class="content">
                	...
                	<ul>
 <li><a href="${pageContext.request.contextPath}/adminController/addEmployee">Click here to add Employee</a></li>
<li><a href="${pageContext.request.contextPath}/adminController/addCustomer">Click here to add Customer</a></li>
...
<div class="rightcol">
	...
	<h1> Add Customer</h1>
<spring:form action="${pageContext.request.contextPath}/adminController/addCustomerDb"  modelAttribute="addCustomer" id="addCustomer">  
...
<input type="submit" class="login login-submit" value="Add Customer"/>  
</spring:form> 
